      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
        <div className="bg-white p-8 rounded-lg overEffect">
          <div className="flex items-center  gap-3 mb-4">
            <AiCallSummary />
            <h3 className="text-[24px] font-semibold o2-title mb-2">AI Call Summary</h3>
          </div>
          
          <p className="text-gray-600 mb-4">
            AI Call Summary automatically captures key points, emotions, and sentiments from IVR calls. It integrates with ServiceNow and can be customized to export PDFs to other applications.
          </p>
